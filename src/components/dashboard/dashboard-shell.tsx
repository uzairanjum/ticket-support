  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex-1 lg:pl-64 flex flex-col">
        {/* Top Header */}
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between gap-4 border-b border-gray-200 bg-white/80 backdrop-blur-xl px-4 lg:px-8">
          <div className="flex items-center gap-4 lg:hidden">
            <Sheet>
              ...
              <SheetContent side="left" className="w-64 p-0 border-r-gray-200">
                <div className="flex h-16 items-center px-6 border-b border-gray-200">
                  <div className="flex items-center gap-2.5">
                    <div className="h-8 w-8 rounded-lg bg-[#005430] flex items-center justify-center">
                      <Ticket className="h-4.5 w-4.5 text-white" />
                    </div>
            ...
            <div className="flex items-center gap-2">
              <div className="h-7 w-7 rounded-lg bg-[#005430] flex items-center justify-center">
          ...
          <div className="flex flex-1 items-center justify-end gap-2 sm:gap-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  className="relative h-9 w-9 rounded-full p-0 overflow-hidden border border-gray-200"
                >
                  <div className="h-full w-full bg-gradient-to-br from-[#005430] to-[#51A26A] flex items-center justify-center text-white text-xs font-bold">
                    {user?.name?.[0]?.toUpperCase()}
                  </div>
                </Button>
              </DropdownMenuTrigger>
